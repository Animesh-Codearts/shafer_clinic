...
if ( ! class_exists( 'shaferclinic_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	
	 */
	class shaferclinic_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'shaferclinic' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'shaferclinic' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'shaferclinic' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'shaferclinic' ),
						'full'    => esc_html__( 'Full text', 'shaferclinic' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-shaferclinic-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'shaferclinic_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new shaferclinic_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'shaferclinic' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
